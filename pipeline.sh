...
# docker exec cyclegan python /cyclegan/cyclegan/prepare_cyclegan.py --name synth_polyp_V9 --synth-dataset /cyclegan/data/synth_polyp_V9 --real-dataset /polyp-data/TrainDataset/images --size 1150

## Train Cyclegan using real images and unrealistic synthetic images 
# docker exec cyclegan python /cyclegan/cyclegan/train.py --dataroot /cyclegan/data/synth_polyp_V9/ --name synth_polyp_V9 --model cycle_gan --checkpoints_dir /cyclegan/data/synth_polyp_V9/checkpoints
